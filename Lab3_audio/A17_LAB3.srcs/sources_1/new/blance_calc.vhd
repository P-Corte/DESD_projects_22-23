...
architecture Behavioral of blance_calc is
    ...
    begin
        if rising_edge(aclk) then
            if nuovo = '1' then
                ...
                if volume_buffer_var(volume_buffer_var'length-1) = '0' then --parte inferiore            
                ...
                elsif volume_buffer_var(volume_buffer_var'length-1) = '1' then  --parte inferiore
                    valore_var := to_integer(unsigned(volume_buffer_var));
